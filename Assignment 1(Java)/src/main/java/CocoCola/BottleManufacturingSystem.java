...
public class BottleManufacturingSystem {
    ...
    private void takeInput() throws InputMismatchException{
        ...
        if(bottleTypeB2 <0) throw new InputMismatchException();
        if(bottleTypeB1 <0) throw new InputMismatchException();
        if(timeToObserveSystem <0) throw new InputMismatchException();
    }
